...
class IpAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ip_address" do
    assert_difference('IpAddress.count') do
      post ip_addresses_url, params: { ip_address: { ip_address: @ip_address.ip_address, user_id: @ip_address.user_id } }
    end
  ...
  test "should update ip_address" do
    patch ip_address_url(@ip_address), params: { ip_address: { ip_address: @ip_address.ip_address, user_id: @ip_address.user_id } }
